...
<main class="max-h-[100vh] w-[100vw] overflow-y-hidden">
  <div class="h-[100vh] w-[100vw] bg-cover bg-center bg-no-repeat shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] shadow-[#0A5C71] flex flex-col justify-center items-center" style="background-image: url(/bg/background_waves.png);">
